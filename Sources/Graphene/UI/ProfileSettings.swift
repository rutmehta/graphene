    ...
    var body: some View {
        Form {
            Section {
                ...
                SettingsHelp("Profiles isolate website cookies, logins and storage. Threads and Vault remain in your shared local library. Existing tabs adopt a changed space profile after restarting Graphene.")
            }
